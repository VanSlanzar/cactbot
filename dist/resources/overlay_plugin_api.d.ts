...
declare const processEvent: <T extends "CombatData" | "LogLine" | "ChangeZone" | "ChangePrimaryPlayer" | "OnlineStatusChanged" | "PartyChanged" | "BroadcastMessage" | "EnmityTargetData" | "onForceReload" | "onGameExistsEvent" | "onGameActiveChangedEvent" | "onLogEvent" | "onImportLogEvent" | "onInCombatChangedEvent" | "onZoneChangedEvent" | "onFateEvent" | "onCEEvent" | "onPlayerDied" | "onPartyWipe" | "onPlayerChangedEvent" | "onUserFileChanged">(msg: Parameters<EventMap[T]>[0]) => void;
export declare const dispatchOverlayEvent: <T extends "CombatData" | "LogLine" | "ChangeZone" | "ChangePrimaryPlayer" | "OnlineStatusChanged" | "PartyChanged" | "BroadcastMessage" | "EnmityTargetData" | "onForceReload" | "onGameExistsEvent" | "onGameActiveChangedEvent" | "onLogEvent" | "onImportLogEvent" | "onInCombatChangedEvent" | "onZoneChangedEvent" | "onFateEvent" | "onCEEvent" | "onPlayerDied" | "onPartyWipe" | "onPlayerChangedEvent" | "onUserFileChanged">(msg: Parameters<EventMap[T]>[0]) => void;
